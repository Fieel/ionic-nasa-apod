...
export class SettingsService {
  ...
  constructor(
    ...
    private imageLoader: IonicImageLoader
  ) {
  ...
  public fetchStorageData() {
    ...
    this.storage.get('favourites').then(data => {
      console.log('lettura preferiti in corso...');
      if (data) {
        this.favourites = data;
        console.log('Preferiti caricati!', this.favourites);
      } else {
        console.log('nessun preferito, settaggio di un array vuoto...');
        this.favourites = [];
      }
    });
    ...
    this.storage.get('todayLayout').then(data => {
      if (data) {
        ...
        console.log(
          'Layout pagina today caricato dallo storage!',
          this.todayLayout
        );
      } else {
    ...
    this.storage.get('weekLayout').then(data => {
      if (data) {
        ...
        console.log(
          'Layout pagina week caricato dallo storage!',
          this.weekLayout
        );
      } else {
    ...
    this.storage.get('resultLayout').then(data => {
      if (data) {
        ...
        console.log(
          'Layout pagina result caricato dallo storage!',
          this.resultLayout
        );
      } else {
    ...
    this.storage.get('favouritesLayout').then(data => {
      if (data) {
        ...
        console.log(
          'Layout pagina favourites caricato dallo storage!',
        ...
        console.log(
          'Layout pagina favourites inizializzata: ',
          this.favouritesLayout
        );
      }
    });
  ...
  public clearImgCache() {
    console.log('clearImgCache not implemented yet');
  ...
  public checkIfFavouritesAreAvailable() {
    console.log('checking if favourites are available');
  ...
  //i l nuovo valore nello storage del telefono.
  public increaseDays() {
    this.daysInThePast++;
